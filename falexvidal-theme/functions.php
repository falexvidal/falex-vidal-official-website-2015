...
//function wow_animations() {

//  wp_register_script( 'jquery', get_template_directory_uri() . '/js/jquery-1.10.2.min.js', array('jquery'), '1.10.2' );
//  wp_register_script( 'wow', get_template_directory_uri() . '/js/wow.js', array('wow'), '1.0' );
